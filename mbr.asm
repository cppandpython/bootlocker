...
%define THEME_LOCKED        0x0C
%define THEME_UNLOCKED      0x0A
...
MSG         db                  "[ LINBOOTLOCKER ]",                13, 10
            db                  "  STATUS:HALTED",                  13, 10, 13, 10
            db                  "Your system is completely locked", 13, 10
            db                  "Enter password to unlock it",      13, 10, 0
